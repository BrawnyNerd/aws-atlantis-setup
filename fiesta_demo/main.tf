...
module "atlantis" {
  ...
  # Setting the Environment Variables in our Atlantis Docker
  custom_environment_variables = [
    {
      name : "TF_VAR_TSKEY_EPHEMERAL_SERVER",
      value : var.TSKEY_EPHEMERAL_SERVER,
    },
    {
    ...
    },
    {
      ...
      value : var.GODADDY_API_KEY,
    },
    {
      name : "GODADDY_API_SECRET",
      value : var.GODADDY_API_SECRET,
    },
  ]
  ...
  allow_unauthenticated_access = true # Required for Github Webhooks
